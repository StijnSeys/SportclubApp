namespace SportClub.Data.Migrations
{
    ...
    public partial class extramaterial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Sport_SportId, t.Member_MemberId })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SportMembers", "Member_MemberId", "dbo.Members");
            DropForeignKey("dbo.SportMembers", "Sport_SportId", "dbo.Sports");
            ...
            DropIndex("dbo.SportMembers", new[] { "Member_MemberId" });
            DropIndex("dbo.SportMembers", new[] { "Sport_SportId" });
